...
| GĐ‑43 | ScreenGenerator (doc 12): sinh **83 màn hình** khai báo từ registry (47 D3/nhóm thiết bị · 18 D2/cell tổng quan · 18 D4/cell chẩn đoán), đạt §10 ≥ 70. Là DANH MỤC: không ép vào nav live (tránh ô rỗng vì đa số tag breadth chưa có dữ liệu sim); nav live vẫn dùng 3 màn hình boiler thủ công. Ô đại diện = float đầu (D3/D2) hoặc tag có alarm (D4); trần 12 ô/màn hình | doc 12 |
