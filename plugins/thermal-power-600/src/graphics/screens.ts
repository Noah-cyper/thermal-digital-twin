...
export const boilerScreens: ReadonlyArray<ScreenDef> = [
  ...
  },
  {
    ...
    elements: [
      ...
      equip('m-scr', 'box', 'SCR deNOx', 'ECTL_SCR_REMOVAL_01', '%', 'D3-fluegas-detail', 665, 67, 110, 54, [], 'AH_SCR_SCORE_01'),
      equip('m-esp', 'box', 'Lọc bụi ESP', 'EMI_DUST_STACK_01', 'mg/m³', 'D3-fluegas-detail', 805, 67, 110, 54, [], 'AH_ESP_SCORE_01'),
      equip('m-idfan', 'pump', 'Quạt ID', 'FAN_ID_FLOW_01', 'kg/s', 'D3-fan-system', 950, 62, 64, 64, [], 'AH_FAN_ID_SCORE_01'),
      equip('m-fgd', 'box', 'FGD deSOx', 'ECTL_FGD_REMOVAL_01', '%', 'D3-fluegas-detail', 1044, 67, 110, 54, [], 'AH_FGD_SCORE_01'),
      equip('m-stack', 'stack', 'Ống khói', 'BLR_FLUE_O2_01', '%', 'D3-flue-stack', 1190, 20, 48, 150, [
        { when: 'lt', value: 1.5, sev: 2 },
      ]),
      // ④ Tuabin — máy phát
      equip('m-hp', 'turbine', 'Turbine HP', 'TRB_HP_MW_01', 'MW', 'D3-turbine-detail', 560, 293, 104, 74, [], 'AH_TURBINE_GEN_SCORE_01'),
      equip('m-ip', 'turbine', 'Turbine IP', 'TRB_IP_MW_01', 'MW', 'D3-turbine-detail', 712, 293, 104, 74),
      equip('m-lp', 'turbine', 'Turbine LP', 'TRB_LP_MW_01', 'MW', 'D3-turbine-detail', 864, 293, 104, 74),
      equip('m-gen', 'generator', 'Máy phát', 'GEN_MW_01', 'MW', 'D3-electrical-detail', 1016, 284, 92, 92, [], 'AH_GENERATOR_SCORE_01'),
      // ⑥ Điện
      equip('m-avr', 'box', 'AVR & kích từ', 'ELEC_EXCITATION_01', '%', 'D3-avr-excitation', 1016, 168, 110, 54),
      equip('m-gsu', 'transformer', 'MBA chính GSU', 'ELEC_GSU_LOADING_01', '%', 'D3-electrical-detail', 1160, 281, 80, 98, [], 'AH_GSU_TRANSFORMER_SCORE_01'),
      equip('m-grid', 'box', 'Lưới 500kV', 'ELEC_GRID_MW_01', 'MW', 'D3-switchyard', 1300, 302, 120, 56),
      equip('m-net', 'box', 'Xuất lưới (net)', 'ELEC_NET_MW_01', 'MW', 'D3-electrical-detail', 1470, 302, 120, 56),
      equip('m-aux', 'box', 'Điện tự dùng (UAT)', 'ELEC_AUX_POWER_01', 'MW', 'D3-electrical-detail', 1300, 430, 120, 56),
      // ④ Ngưng tụ – cấp nước
      equip('m-cond', 'condenser', 'Bình ngưng', 'TRB_COND_VACUUM_01', 'kPa', 'D3-cooling-detail', 864, 452, 104, 60, [
        { when: 'gt', value: 12, sev: 2 },
      ], 'AH_CONDENSER_SCORE_01'),
      equip('m-lph', 'box', 'Gia nhiệt hạ áp', 'FW_LPH1_TEMP_01', '°C', 'D3-feedwater-detail', 710, 512, 110, 56, [], 'AH_LP_HEATER_SCORE_01'),
      equip('m-dea', 'box', 'Khử khí (DEA)', 'FW_DEAERATOR_LEVEL_01', '%', 'D3-feedwater-detail', 540, 512, 110, 56, [], 'AH_DEAERATOR_SCORE_01'),
      equip('m-bfp', 'pump', 'Bơm cấp BFP', 'FW_FLOW_01', 't/h', 'D3-feedwater-detail', 410, 506, 68, 68, [], 'AH_BFP_SCORE_01'),
      equip('m-hph', 'box', 'Gia nhiệt cao áp', 'FW_HPH3_TEMP_01', '°C', 'D3-feedwater-detail', 240, 512, 110, 56, [], 'AH_HP_HEATER_SCORE_01'),
      // ⑤ Nước tuần hoàn
      equip('m-ct', 'box', 'Tháp giải nhiệt', 'CT_APPROACH_01', '°C', 'D3-cooling-detail', 864, 690, 120, 64, [], 'AH_COOLING_TOWER_SCORE_01'),
      equip('m-cwp', 'pump', 'Bơm nước tuần hoàn', 'CT_CW_SUPPLY_01', '°C', 'D3-cooling-detail', 1020, 688, 68, 68, [], 'AH_CW_SYSTEM_SCORE_01'),
      // ⑥ Thải tro – xỉ
  ...
  {
    screenId: 'D3-agc-secondary',
    level: 'D3',
    title: { vi: 'AGC — điều tần thứ cấp & tie-line bias', en: 'AGC Secondary Frequency Control' },
    elements: [
      // AGC khôi phục tần số + đưa tie-line về lịch qua ACE = ΔP_tie + B·Δf.
      equip('agc-en', 'box', 'AGC (0/1)', 'AGC_ENABLED_01', '', '', 20, 40, 190, 56, [{ when: 'lt', value: 0.5, sev: 2 }]),
      equip('agc-bias', 'box', 'Frequency bias', 'AGC_FREQ_BIAS_01', 'MW/Hz', '', 20, 112, 190, 56),
      equip('agc-sched', 'box', 'Lịch tie-line', 'AGC_TIE_SCHED_01', 'MW', '', 20, 184, 190, 56),
      equip('agc-tie', 'box', 'Dòng tie-line', 'AGC_TIE_FLOW_01', 'MW', '', 20, 256, 190, 56),
      pipe('agc-p1', 'elec', [{ x: 210, y: 68 }, { x: 260, y: 68 }, { x: 260, y: 90 }]),
      equip('agc-ace', 'drum', 'ACE', 'AGC_ACE_01', 'MW', '', 260, 40, 200, 90, [{ when: 'gt', value: 15, sev: 2 }]),
      equip('agc-reg', 'box', 'Điều tiết (regulation)', 'AGC_REG_SIGNAL_01', 'MW', '', 260, 148, 200, 56),
      equip('agc-sp', 'box', 'Setpoint tải AGC', 'AGC_SETPOINT_01', 'MW', '', 260, 220, 200, 56),
      equip('agc-cps', 'box', 'CPS đạt (0/1)', 'AGC_CPS_OK_01', '', '', 490, 40, 200, 56, [{ when: 'lt', value: 0.5, sev: 1 }]),
      equip('agc-health', 'box', 'Còn margin (0/1)', 'AGC_HEALTHY_01', '', 'D3-governor-droop', 490, 112, 200, 56, [{ when: 'lt', value: 0.5, sev: 2 }]),
    ],
  },
  {
    screenId: 'D3-combustion-opt',
    level: 'D3',
    title: { vi: 'Tối ưu cháy & hiệu suất lò (phía cháy)', en: 'Combustion Optimization & Boiler Efficiency' },
    elements: [
      // Đường cong hiệu suất theo gió thừa: O₂ thấp → LOI/unburned; O₂ cao → dry gas loss. Có điểm tối ưu.
      equip('cmb-o2', 'box', 'O₂ khói', 'CMB_O2_MEAS_01', '%', '', 20, 40, 190, 56),
      equip('cmb-opt', 'box', 'O₂ tối ưu', 'CMB_O2_OPTIMUM_01', '%', '', 20, 112, 190, 56),
      equip('cmb-ea', 'box', 'Gió thừa', 'CMB_EXCESS_AIR_01', '%', '', 20, 184, 190, 56),
      equip('cmb-loi', 'box', 'Carbon-in-ash (LOI)', 'CMB_LOI_01', '%', '', 20, 256, 190, 56, [{ when: 'gt', value: 8, sev: 2 }]),
      equip('cmb-dry', 'box', 'Tổn thất khói khô', 'CMB_DRY_GAS_LOSS_01', '%', '', 260, 40, 200, 56),
      equip('cmb-unb', 'box', 'Tổn thất chưa cháy', 'CMB_UNBURNED_LOSS_01', '%', '', 260, 112, 200, 56),
      equip('cmb-eff', 'drum', 'Hiệu suất lò (ước lượng)', 'CMB_BOILER_EFF_EST_01', '%', '', 260, 184, 200, 90, [{ when: 'lt', value: 87, sev: 2 }]),
      equip('cmb-gap', 'box', 'Hụt so tối ưu', 'CMB_EFF_GAP_01', '%', '', 490, 40, 200, 56, [{ when: 'gt', value: 1, sev: 2 }]),
      equip('cmb-health', 'box', 'Cháy gần tối ưu', 'CMB_HEALTHY_01', '', 'D3-pulverizer-mills', 490, 112, 200, 56, [{ when: 'lt', value: 0.5, sev: 2 }]),
    ],
  },
  {
    screenId: 'D3-heater-detail',
    level: 'D3',
    title: { vi: 'Bình gia nhiệt — chi tiết từng bình (HP1–LP4)', en: 'Feedwater Heaters — Per-Heater Detail' },
    elements: [
      // Từng bình: mức nước ngưng + TTD. Van drain kẹt → mức dâng → ngập ống → TTD xấu.
      equip('htr-hp1', 'box', 'HP1: mức/TTD', 'HTR_HP1_LEVEL_01', '%', '', 20, 40, 150, 56, [{ when: 'gt', value: 80, sev: 2 }]),
      equip('htr-hp2', 'box', 'HP2: mức', 'HTR_HP2_LEVEL_01', '%', '', 20, 112, 150, 56, [{ when: 'gt', value: 80, sev: 2 }]),
      equip('htr-hp3', 'box', 'HP3: mức', 'HTR_HP3_LEVEL_01', '%', '', 20, 184, 150, 56, [{ when: 'gt', value: 80, sev: 2 }]),
      equip('htr-lp1', 'box', 'LP1: mức', 'HTR_LP1_LEVEL_01', '%', '', 20, 256, 150, 56, [{ when: 'gt', value: 80, sev: 2 }]),
      equip('htr-lp2', 'box', 'LP2: mức', 'HTR_LP2_LEVEL_01', '%', '', 20, 328, 150, 56, [{ when: 'gt', value: 80, sev: 2 }]),
      equip('htr-lp3', 'box', 'LP3: mức', 'HTR_LP3_LEVEL_01', '%', '', 190, 40, 150, 56, [{ when: 'gt', value: 80, sev: 2 }]),
      equip('htr-lp4', 'box', 'LP4: mức', 'HTR_LP4_LEVEL_01', '%', '', 190, 112, 150, 56, [{ when: 'gt', value: 80, sev: 2 }]),
      equip('htr-worst', 'drum', 'TTD xấu nhất', 'HTR_WORST_TTD_01', '°C', '', 190, 184, 150, 100, [{ when: 'gt', value: 6, sev: 2 }]),
      equip('htr-maxlvl', 'box', 'Mức cao nhất', 'HTR_MAX_LEVEL_01', '%', '', 360, 40, 190, 56, [{ when: 'gt', value: 80, sev: 2 }]),
      equip('htr-stuck', 'box', 'Số bình kẹt', 'HTR_STUCK_COUNT_01', '', '', 360, 112, 190, 56, [{ when: 'gt', value: 0, sev: 2 }]),
      equip('htr-pen', 'box', 'Hụt nhiệt nước cấp', 'HTR_FW_TEMP_PENALTY_01', '°C', '', 360, 184, 190, 56),
      equip('htr-health', 'box', 'Đoàn bình thường', 'HTR_HEALTHY_01', '', 'D3-fwh-drains', 360, 256, 190, 56, [{ when: 'lt', value: 0.5, sev: 2 }]),
    ],
  },
  {
    screenId: 'D3-drum-swell',
    level: 'D3',
    title: { vi: 'Bao hơi — động học shrink/swell (2 pha)', en: 'Drum Shrink/Swell Dynamics' },
    elements: [
      // Non-minimum-phase: tăng tải → áp tụt → bọt nở → mức DÂNG dù khối lượng giảm (và ngược lại).
      equip('drm-rate', 'box', 'Tốc độ đổi hơi', 'DRM_STEAM_RATE_01', 't/h/ph', '', 20, 40, 200, 56),
      equip('drm-swell', 'drum', 'Swell(+)/Shrink(−)', 'DRM_SWELL_MM_01', 'mm', '', 20, 112, 200, 90, [{ when: 'gt', value: 40, sev: 2 }, { when: 'lt', value: -40, sev: 2 }]),
      equip('drm-active', 'box', 'Đang swell/shrink', 'DRM_SWELL_ACTIVE_01', '', '', 20, 220, 200, 56, [{ when: 'gt', value: 0.5, sev: 1 }]),
      equip('drm-app', 'box', 'Mức biểu kiến (đo)', 'DRM_APPARENT_LEVEL_01', 'mm', '', 250, 40, 200, 56),
      equip('drm-true', 'box', 'Mức thật (khối lượng)', 'DRM_TRUE_LEVEL_EST_01', 'mm', '', 250, 112, 200, 56),
      equip('drm-peak', 'box', 'Swell đỉnh phiên', 'DRM_SWELL_PEAK_01', 'mm', '', 250, 184, 200, 56),
      equip('drm-health', 'box', 'Mức ổn định (0/1)', 'DRM_HEALTHY_01', '', 'D3-steam-drum', 250, 256, 200, 56, [{ when: 'lt', value: 0.5, sev: 2 }]),
    ],
  },
  {
  ...
  {
    // Sơ đồ CHI TIẾT hệ Turbine–Máy phát: HP→IP→LP→máy phát · bình ngưng · gối trục/rung · dầu bôi trơn · TSE.
    screenId: 'D3-turbine-detail',
    level: 'D3',
    title: { vi: 'Turbine–Máy phát — sơ đồ chi tiết', en: 'Turbine–Generator — Detailed Mimic' },
    elements: [
      equip('tdv-steam', 'box', 'Hơi chính vào', 'TRB_STODOLA_FLOW', 't/h', 'D3-boiler-detail', 30, 74, 156, 70),
      equip('tdv-hp', 'turbine', 'Turbine HP', 'TRB_HP_MW_01', 'MW', '', 210, 70, 150, 80),
      equip('tdv-ip', 'turbine', 'Turbine IP', 'TRB_IP_MW_01', 'MW', '', 388, 70, 150, 80),
      equip('tdv-lp', 'turbine', 'Turbine LP', 'TRB_LP_MW_01', 'MW', '', 566, 70, 150, 80),
      equip('tdv-gen', 'box', 'Máy phát', 'GEN_MW_01', 'MW', 'D3-electrical-detail', 744, 70, 170, 80),
      equip('tdv-mvar', 'box', 'Công suất phản kháng', 'GEN_MVAR_01', 'MVAr', '', 942, 74, 168, 60),
      equip('tdv-mvaload', 'box', 'Tải MVA (P-Q)', 'GCAP_MVA_LOADING_01', '%', 'D3-generator-capability', 1128, 74, 168, 60, [{ when: 'gt', value: 100, sev: 2 }]),
      equip('tdv-freq', 'box', 'Tần số', 'GEN_FREQ_01', 'Hz', '', 942, 150, 168, 60, [{ when: 'gt', value: 50.2, sev: 2 }, { when: 'lt', value: 49.8, sev: 2 }]),
      equip('tdv-stator', 'box', 'Nhiệt stator', 'GEN_STATOR_TEMP_01', '°C', '', 1128, 150, 168, 60, [{ when: 'gt', value: 110, sev: 2 }]),
      equip('tdv-speed', 'box', 'Tốc độ trục', 'TRB_SPEED_01', 'rpm', '', 210, 160, 150, 58, [{ when: 'gt', value: 3120, sev: 1 }]),
      equip('tdv-gland', 'box', 'Áp hơi chèn', 'TRB_GLAND_PRESS_01', 'kPag', '', 388, 160, 150, 58, [{ when: 'lt', value: 2, sev: 2 }]),
      // Bình ngưng
      equip('tdv-cond', 'condenser', 'Bình ngưng', 'TRB_COND_VACUUM_01', 'kPa', 'D3-cooling-detail', 566, 240, 150, 76, [{ when: 'gt', value: 12, sev: 2 }]),
      equip('tdv-sat', 'box', 'Nhiệt bão hoà', 'CNDP_SAT_TEMP_01', '°C', '', 744, 250, 156, 58),
      equip('tdv-ttd', 'box', 'TTD bình ngưng', 'CNDP_TTD_01', '°C', 'D3-condenser-perf', 912, 250, 156, 58, [{ when: 'gt', value: 5, sev: 2 }]),
      equip('tdv-clean', 'box', 'Độ sạch ống', 'CNDP_CLEANLINESS_01', '%', '', 1080, 250, 156, 58, [{ when: 'lt', value: 80, sev: 2 }]),
      // Cơ khí & dầu bôi trơn
      equip('tdv-brg', 'box', 'Nhiệt gối trục', 'TRB_BRG_TEMP_01', '°C', '', 30, 350, 160, 58, [{ when: 'gt', value: 110, sev: 2 }]),
      equip('tdv-vib', 'box', 'Rung trục', 'TRB_VIB_01', 'mm/s', '', 200, 350, 150, 58, [{ when: 'gt', value: 7, sev: 2 }]),
      equip('tdv-lubehdr', 'box', 'Áp dầu bôi trơn', 'LUBE_HEADER_PRESS_01', 'MPa', 'D3-lube-oil', 360, 350, 160, 58, [{ when: 'lt', value: 0.12, sev: 1 }]),
      equip('tdv-luberes', 'box', 'Nhiệt bể dầu', 'LUBE_RESERVOIR_TEMP_01', '°C', '', 530, 350, 156, 58),
      equip('tdv-lubefilt', 'box', 'ΔP lọc dầu', 'LUBE_FILTER_DP_01', 'kPa', '', 696, 350, 156, 58, [{ when: 'gt', value: 150, sev: 2 }]),
      equip('tdv-lubemop', 'box', 'Bơm dầu chính (MOP)', 'LUBE_MOP_RUN_01', '', '', 862, 350, 168, 58),
      // TSE — ứng suất nhiệt rotor
      equip('tdv-tsestress', 'box', 'TSE ứng suất', 'TSE_STRESS_PCT_01', '%', 'D3-turbine-stress', 30, 430, 160, 58, [{ when: 'gt', value: 85, sev: 2 }]),
      equip('tdv-tsedt', 'box', 'Chênh nhiệt rotor', 'TSE_ROTOR_DT_01', '°C', '', 200, 430, 160, 58),
      equip('tdv-tselife', 'box', 'Tuổi thọ đã dùng', 'TSE_LIFE_USED_01', '%', '', 370, 430, 160, 58),
      equip('tdv-tsemargin', 'box', 'Biên TSE', 'TSE_MARGIN_01', '%', '', 540, 430, 156, 58),
      pipe('tdv-p1', 'steam', [{ x: 186, y: 110 }, { x: 210, y: 110 }]),
      pipe('tdv-p2', 'steam', [{ x: 360, y: 110 }, { x: 388, y: 110 }]),
      pipe('tdv-p3', 'steam', [{ x: 538, y: 110 }, { x: 566, y: 110 }]),
      pipe('tdv-p4', 'shaft', [{ x: 716, y: 110 }, { x: 744, y: 110 }]),
      pipe('tdv-p5', 'steam', [{ x: 641, y: 150 }, { x: 641, y: 240 }]),
    ],
  },
  {
    // Sơ đồ CHI TIẾT hệ Điện: máy phát→GSU→lưới 500kV · AVR/kích từ · PSS · điều tốc · AGC · tự dùng · làm mát máy phát.
    screenId: 'D3-electrical-detail',
    level: 'D3',
    title: { vi: 'Điện — sơ đồ chi tiết (máy phát · GSU · 500 kV · AVR · AGC)', en: 'Electrical — Detailed Mimic' },
    elements: [
      equip('edv-gen', 'box', 'Máy phát', 'GEN_MW_01', 'MW', 'D3-turbine-detail', 30, 74, 156, 74),
      equip('edv-gsu', 'box', 'MBA chính GSU', 'ELEC_GSU_LOADING_01', '%', '', 208, 74, 156, 74, [{ when: 'gt', value: 100, sev: 2 }]),
      equip('edv-brk', 'box', 'Máy cắt đầu cực', 'ELEC_BREAKER_01', '', '', 386, 74, 150, 74),
      equip('edv-bus', 'box', 'Thanh cái 500 kV', 'SY_BUS_A_KV_01', 'kV', 'D3-switchyard', 560, 74, 156, 74),
      equip('edv-line1', 'box', 'Đường dây 1', 'SY_LINE1_MW_01', 'MW', '', 738, 74, 156, 74),
      equip('edv-grid', 'box', 'Xuất lưới', 'ELEC_GRID_MW_01', 'MW', '', 916, 74, 156, 74),
      equip('edv-net', 'box', 'Công suất net', 'ELEC_NET_MW_01', 'MW', '', 1094, 74, 156, 74),
      equip('edv-mvar', 'box', 'Phản kháng', 'GEN_MVAR_01', 'MVAr', '', 30, 162, 156, 58),
      equip('edv-mva', 'box', 'MVA máy phát', 'ELEC_GEN_MVA_01', 'MVA', '', 208, 162, 156, 58),
      equip('edv-pf', 'box', 'Hệ số công suất', 'ELEC_PF_01', '', '', 386, 162, 150, 58),
      equip('edv-line2', 'box', 'Đường dây 2', 'SY_LINE2_MW_01', 'MW', '', 738, 162, 156, 58),
      // AVR & kích từ
      equip('edv-tv', 'box', 'Điện áp cực (pu)', 'ELEC_TERM_VOLT_PU_01', 'pu', 'D3-avr-excitation', 30, 250, 156, 58),
      equip('edv-field', 'box', 'Dòng kích từ', 'ELEC_FIELD_CURRENT_01', 'A', '', 208, 250, 156, 58),
      equip('edv-exc', 'box', 'Kích từ (OP)', 'ELEC_EXCITATION_01', '%', '', 386, 250, 150, 58),
      equip('edv-avrsp', 'box', 'Setpoint AVR', 'ELEC_AVR_SETPOINT_01', 'pu', '', 560, 250, 156, 58),
      // PSS + điều tốc
      equip('edv-pss', 'box', 'PSS (đầu ra)', 'PSS_OUTPUT_01', '', 'D3-pss-stabilizer', 30, 338, 156, 58),
      equip('edv-pssd', 'box', 'Hệ số tắt dao động', 'PSS_DAMPING_RATIO_01', '', '', 208, 338, 156, 58),
      equip('edv-govf', 'box', 'Tần số lưới', 'GOV_GRID_FREQ_01', 'Hz', 'D3-governor-droop', 386, 338, 150, 58, [{ when: 'lt', value: 49.8, sev: 2 }]),
      equip('edv-pfr', 'box', 'PFR điều tốc', 'GOV_PFR_MW_01', 'MW', '', 560, 338, 156, 58),
      equip('edv-govv', 'box', 'Vị trí van điều tốc', 'GOV_VALVE_POS_01', '%', '', 738, 338, 156, 58),
      // AGC + tự dùng
      equip('edv-ace', 'box', 'AGC — ACE', 'AGC_ACE_01', 'MW', 'D3-agc-secondary', 30, 426, 156, 58),
      equip('edv-tie', 'box', 'Dòng tie-line', 'AGC_TIE_FLOW_01', 'MW', '', 208, 426, 156, 58),
      equip('edv-aux', 'box', 'Điện tự dùng', 'ELEC_AUX_POWER_01', 'MW', '', 386, 426, 150, 58),
      equip('edv-auxl', 'box', 'Tải tự dùng', 'ELEC_AUX_LOADING_01', '%', '', 560, 426, 156, 58),
      // Làm mát máy phát
      equip('edv-h2p', 'box', 'Áp H₂ máy phát', 'ELEC_H2_PRESS_01', 'MPa', '', 30, 514, 156, 58),
      equip('edv-h2t', 'box', 'Nhiệt H₂', 'ELEC_H2_TEMP_01', '°C', '', 208, 514, 156, 58, [{ when: 'gt', value: 50, sev: 2 }]),
      equip('edv-seal', 'box', 'ΔP dầu chèn', 'ELEC_SEAL_OIL_DP_01', 'MPa', '', 386, 514, 150, 58),
      equip('edv-scw', 'box', 'Nhiệt nước làm mát stator', 'ELEC_STATOR_CW_TEMP_01', '°C', '', 560, 514, 168, 58),
      pipe('edv-p1', 'elec', [{ x: 186, y: 111 }, { x: 208, y: 111 }]),
      pipe('edv-p2', 'elec', [{ x: 364, y: 111 }, { x: 386, y: 111 }]),
      pipe('edv-p3', 'elec', [{ x: 536, y: 111 }, { x: 560, y: 111 }]),
      pipe('edv-p4', 'elec', [{ x: 716, y: 111 }, { x: 738, y: 111 }]),
      pipe('edv-p5', 'elec', [{ x: 894, y: 111 }, { x: 916, y: 111 }]),
    ],
  },
  {
    // Sơ đồ CHI TIẾT hệ Nước cấp–ngưng: bình ngưng→CEP→gia nhiệt hạ áp→khử khí→BFP→gia nhiệt cao áp→econ + drain.
    screenId: 'D3-feedwater-detail',
    level: 'D3',
    title: { vi: 'Nước cấp & ngưng — sơ đồ chi tiết', en: 'Feedwater & Condensate — Detailed Mimic' },
    elements: [
      equip('fdv-cond', 'box', 'Hotwell bình ngưng', 'COND_HOTWELL_LEVEL_01', '%', 'D3-cooling-detail', 30, 74, 156, 64),
      equip('fdv-cep', 'box', 'Bơm ngưng (CEP)', 'COND_CEP_LCV_01', '%', '', 208, 74, 156, 64),
      equip('fdv-ctemp', 'box', 'Nhiệt nước ngưng', 'FW_CONDENSATE_TEMP_01', '°C', '', 386, 74, 150, 64),
      equip('fdv-lph1', 'box', 'Gia nhiệt hạ áp 1', 'FW_LPH1_TEMP_01', '°C', 'D3-heater-detail', 560, 74, 150, 64),
      equip('fdv-lph2', 'box', 'GN hạ áp 2', 'FW_LPH2_TEMP_01', '°C', 'D3-heater-detail', 728, 74, 150, 64),
      equip('fdv-lph3', 'box', 'GN hạ áp 3', 'FW_LPH3_TEMP_01', '°C', 'D3-heater-detail', 896, 74, 150, 64),
      equip('fdv-lph4', 'box', 'GN hạ áp 4', 'FW_LPH4_TEMP_01', '°C', 'D3-heater-detail', 1064, 74, 150, 64),
      // Khử khí
      equip('fdv-dealvl', 'box', 'Mức khử khí', 'FW_DEAERATOR_LEVEL_01', '%', '', 30, 160, 156, 60),
      equip('fdv-deatemp', 'box', 'Nhiệt khử khí', 'FW_DEAERATOR_TEMP_01', '°C', '', 208, 160, 156, 60),
      equip('fdv-deapress', 'box', 'Áp khử khí', 'FW_DEA_PRESS_01', 'MPa', '', 386, 160, 150, 60),
      equip('fdv-dealcv', 'box', 'Van cấp khử khí', 'FW_DEA_LCV_01', '%', '', 560, 160, 150, 60),
      // BFP
      equip('fdv-bfpflow', 'box', 'Bơm cấp BFP (lưu lượng)', 'BFP_FLOW_01', 't/h', 'D3-bfp-cavitation', 30, 248, 175, 60),
      equip('fdv-bfpsuc', 'box', 'Áp hút BFP', 'BFP_SUCTION_PRESS_01', 'MPa', '', 218, 248, 156, 60),
      equip('fdv-npsh', 'box', 'Biên NPSH', 'BFP_NPSH_MARGIN_01', 'm', '', 386, 248, 150, 60, [{ when: 'lt', value: 0, sev: 2 }]),
      equip('fdv-recirc', 'box', 'Van recirc min-flow', 'BFP_RECIRC_VALVE_01', '%', '', 560, 248, 156, 60),
      // Cao áp → econ
      equip('fdv-hph1', 'box', 'Gia nhiệt cao áp 1', 'FW_HPH1_TEMP_01', '°C', 'D3-heater-detail', 30, 336, 160, 60),
      equip('fdv-hph2', 'box', 'GN cao áp 2', 'FW_HPH2_TEMP_01', '°C', 'D3-heater-detail', 200, 336, 156, 60),
      equip('fdv-hph3', 'box', 'GN cao áp 3', 'FW_HPH3_TEMP_01', '°C', 'D3-heater-detail', 368, 336, 156, 60),
      equip('fdv-fwflow', 'box', 'Lưu lượng nước cấp', 'FW_FLOW_01', 't/h', '', 536, 336, 160, 60),
      equip('fdv-econ', 'box', 'Nước cấp vào econ', 'FW_ECON_INLET_TEMP_01', '°C', 'D3-boiler-detail', 706, 336, 168, 60),
      // Drain cascade
      equip('fdv-hphdrain', 'box', 'Mức drain cao áp', 'HTR_HP1_LEVEL_01', '%', '', 30, 424, 160, 60, [{ when: 'gt', value: 90, sev: 2 }]),
      equip('fdv-lphdrain', 'box', 'Mức drain hạ áp', 'HTR_LP1_LEVEL_01', '%', '', 200, 424, 156, 60),
      equip('fdv-worstttd', 'box', 'TTD xấu nhất', 'HTR_WORST_TTD_01', '°C', 'D3-heater-detail', 368, 424, 156, 60, [{ when: 'gt', value: 5, sev: 2 }]),
      equip('fdv-regen', 'box', 'Hụt nhiệt nước cấp', 'HTR_FW_TEMP_PENALTY_01', '°C', '', 536, 424, 160, 60),
      pipe('fdv-p1', 'water', [{ x: 186, y: 106 }, { x: 208, y: 106 }]),
      pipe('fdv-p2', 'water', [{ x: 536, y: 106 }, { x: 560, y: 106 }]),
      pipe('fdv-p3', 'water', [{ x: 710, y: 106 }, { x: 728, y: 106 }]),
      pipe('fdv-p4', 'water', [{ x: 205, y: 278 }, { x: 218, y: 278 }]),
    ],
  },
  {
    // Sơ đồ CHI TIẾT đường khói–phát thải: econ→sấy gió→SCR→ESP→quạt ID→FGD→ống khói + NOx/SO₂/bụi/Hg/CO.
    screenId: 'D3-fluegas-detail',
    level: 'D3',
    title: { vi: 'Đường khói & phát thải — sơ đồ chi tiết', en: 'Flue Gas & Emissions — Detailed Mimic' },
    elements: [
      equip('gdv-flow', 'box', 'Lưu lượng khói', 'FG_FLOW_01', 'kg/s', 'D3-boiler-detail', 30, 74, 156, 64),
      equip('gdv-gastemp', 'box', 'Khói vào sấy gió', 'FG_AH_GAS_IN_TEMP_01', '°C', '', 208, 74, 156, 64),
      equip('gdv-stack', 'box', 'Nhiệt khói ống khói', 'FG_STACK_TEMP_01', '°C', 'D3-fouling-air', 386, 74, 156, 64),
      equip('gdv-exair', 'box', 'Dư gió', 'FG_EXCESS_AIR_01', '%', '', 564, 74, 150, 64),
      equip('gdv-lambda', 'box', 'Hệ số λ', 'FG_LAMBDA_01', '', '', 738, 74, 150, 64),
      // SCR deNOx
      equip('gdv-noxin', 'box', 'NOₓ vào SCR', 'EMI_NOX_SCR_IN_01', 'mg/m³', 'D3-emissions-control', 30, 162, 156, 60),
      equip('gdv-noxout', 'box', 'NOₓ ống khói', 'EMI_NOX_STACK_01', 'mg/m³', '', 208, 162, 156, 60, [{ when: 'gt', value: 200, sev: 2 }]),
      equip('gdv-screff', 'box', 'Hiệu suất SCR', 'EMI_SCR_EFF_01', '%', '', 386, 162, 150, 60),
      equip('gdv-nh3slip', 'box', 'Rò NH₃ (slip)', 'ECTL_NH3_SLIP_01', 'ppm', '', 564, 162, 150, 60, [{ when: 'gt', value: 3, sev: 2 }]),
      equip('gdv-scract', 'box', 'Hoạt tính xúc tác', 'ECTL_SCR_ACTIVITY_01', '%', '', 738, 162, 150, 60),
      // ESP lọc bụi
      equip('gdv-dustin', 'box', 'Bụi vào ESP', 'EMI_ESP_IN_DUST_01', 'mg/m³', 'D3-emissions-cems', 30, 250, 156, 60),
      equip('gdv-duststack', 'box', 'Bụi ống khói', 'EMI_DUST_STACK_01', 'mg/m³', '', 208, 250, 156, 60, [{ when: 'gt', value: 30, sev: 2 }]),
      equip('gdv-espeff', 'box', 'Hiệu suất ESP', 'EMI_ESP_EFF_01', '%', '', 386, 250, 150, 60),
      // FGD deSOx
      equip('gdv-so2', 'box', 'SO₂ ống khói', 'EMI_SO2_STACK_01', 'mg/m³', 'D3-emissions-control', 564, 250, 156, 60, [{ when: 'gt', value: 200, sev: 2 }]),
      equip('gdv-fgdeff', 'box', 'Hiệu suất FGD', 'EMI_FGD_EFF_01', '%', '', 742, 250, 150, 60),
      equip('gdv-fgdph', 'box', 'pH slurry FGD', 'ECTL_FGD_PH_01', '', '', 916, 250, 150, 60, [{ when: 'lt', value: 5, sev: 2 }]),
      // Quạt ID
      equip('gdv-ida', 'box', 'Quạt ID A', 'FG_IDA_FLOW_01', 'kg/s', 'D3-fan-system', 30, 338, 156, 60),
      equip('gdv-idb', 'box', 'Quạt ID B', 'FG_IDB_FLOW_01', 'kg/s', 'D3-fan-system', 208, 338, 156, 60),
      // CEMS Hg & CO + CO2
      equip('gdv-hg', 'box', 'Thuỷ ngân Hg', 'CEMS_HG_STACK_01', 'µg/m³', 'D3-cems-hg-co', 30, 426, 156, 60),
      equip('gdv-co', 'box', 'CO (quy 6% O₂)', 'CEMS_CO_CORRECTED_01', 'mg/m³', '', 208, 426, 156, 60, [{ when: 'gt', value: 100, sev: 2 }]),
      equip('gdv-co2', 'box', 'CO₂ phát thải', 'EMI_CO2_RATE_01', 't/h', '', 386, 426, 150, 60),
      pipe('gdv-p1', 'flue', [{ x: 186, y: 106 }, { x: 208, y: 106 }]),
      pipe('gdv-p2', 'flue', [{ x: 364, y: 106 }, { x: 386, y: 106 }]),
      pipe('gdv-p3', 'flue', [{ x: 108, y: 138 }, { x: 108, y: 162 }]),
      pipe('gdv-p4', 'flue', [{ x: 108, y: 222 }, { x: 108, y: 250 }]),
    ],
  },
  {
    // Sơ đồ CHI TIẾT hệ nước tuần hoàn (làm mát): bình ngưng↔bơm CW↔tháp giải nhiệt.
    screenId: 'D3-cooling-detail',
    level: 'D3',
    title: { vi: 'Nước tuần hoàn & tháp giải nhiệt — sơ đồ chi tiết', en: 'Circulating Water & Cooling Tower — Detailed Mimic' },
    elements: [
      equip('cdv-cond', 'condenser', 'Bình ngưng (duty)', 'COND_DUTY_01', 'MW', 'D3-condenser-cw', 30, 74, 160, 76),
      equip('cdv-cwin', 'box', 'CW vào', 'COND_CW_IN_TEMP_01', '°C', '', 210, 80, 156, 60),
      equip('cdv-cwout', 'box', 'CW ra', 'COND_CW_OUT_TEMP_01', '°C', '', 388, 80, 156, 60),
      equip('cdv-cwrise', 'box', 'Chênh nhiệt CW', 'COND_CW_RISE_01', '°C', '', 566, 80, 156, 60),
      equip('cdv-cwflow', 'box', 'Lưu lượng CW', 'COND_CW_FLOW_01', 't/h', '', 744, 80, 156, 60),
      // Bơm CW
      equip('cdv-cwpa', 'box', 'Bơm CW A', 'COND_CWP_A_FLOW_01', 't/h', 'D3-cw-pump', 210, 168, 156, 60),
      equip('cdv-cwpb', 'box', 'Bơm CW B', 'COND_CWP_B_FLOW_01', 't/h', 'D3-cw-pump', 388, 168, 156, 60),
      equip('cdv-ttd', 'box', 'TTD bình ngưng', 'COND_TTD_01', '°C', '', 566, 168, 156, 60, [{ when: 'gt', value: 5, sev: 2 }]),
      equip('cdv-sat', 'box', 'Nhiệt bão hoà', 'COND_SAT_TEMP_01', '°C', '', 744, 168, 156, 60),
      // Tháp giải nhiệt
      equip('cdv-ct', 'cooling', 'Tháp giải nhiệt', 'CT_HEAT_REJECT_01', 'MW', 'D3-cooling-tower', 30, 256, 160, 76),
      equip('cdv-ctsupply', 'box', 'Nước lạnh cấp', 'CT_CW_SUPPLY_01', '°C', '', 210, 262, 156, 60),
      equip('cdv-cthot', 'box', 'Nước nóng về', 'CT_CW_HOT_01', '°C', '', 388, 262, 156, 60),
      equip('cdv-ctrange', 'box', 'Range tháp', 'CT_RANGE_01', '°C', '', 566, 262, 156, 60),
      equip('cdv-ctapproach', 'box', 'Approach', 'CT_APPROACH_01', '°C', '', 744, 262, 156, 60, [{ when: 'gt', value: 8, sev: 2 }]),
      equip('cdv-ctwet', 'box', 'Nhiệt bầu ướt', 'CT_WETBULB_01', '°C', '', 922, 262, 156, 60),
      // Bổ sung & tổn thất
      equip('cdv-evap', 'box', 'Tổn thất bay hơi', 'CT_EVAP_LOSS_01', 't/h', '', 210, 350, 156, 60),
      equip('cdv-makeup', 'box', 'Nước bổ sung', 'CT_MAKEUP_01', 't/h', '', 388, 350, 156, 60),
      equip('cdv-ccw', 'box', 'Nước làm mát kín (CCW)', 'COND_CCW_TEMP_01', '°C', '', 566, 350, 175, 60),
      equip('cdv-hotwell', 'box', 'Mức hotwell', 'COND_HOTWELL_LEVEL_01', '%', 'D3-feedwater-detail', 758, 350, 160, 60),
      pipe('cdv-p1', 'water', [{ x: 190, y: 110 }, { x: 210, y: 110 }]),
      pipe('cdv-p2', 'water', [{ x: 288, y: 140 }, { x: 288, y: 168 }]),
      pipe('cdv-p3', 'water', [{ x: 110, y: 150 }, { x: 110, y: 256 }]),
      pipe('cdv-p4', 'water', [{ x: 190, y: 292 }, { x: 210, y: 292 }]),
    ],
  },
  {
