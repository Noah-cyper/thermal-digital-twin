...
export const thermalNav: ReadonlyArray<NavNode> = [
  ...
  { screenId: 'D3-agc-secondary', level: 'D3', parentId: 'D1-plant-overview', title: { vi: 'AGC — điều tần thứ cấp', en: 'AGC Secondary Control' } },
  { screenId: 'D3-combustion-opt', level: 'D3', parentId: 'D1-plant-overview', title: { vi: 'Tối ưu cháy & hiệu suất lò', en: 'Combustion Optimization' } },
