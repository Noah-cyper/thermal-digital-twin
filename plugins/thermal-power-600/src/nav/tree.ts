...
export const thermalNav: ReadonlyArray<NavNode> = [
  ...
  { screenId: 'D1-plant-health', level: 'D1', title: { vi: 'Sức khoẻ nhà máy (tổng cờ hệ)', en: 'Plant Health Overview' } },
  ...
  { screenId: 'D3-emissions-control', level: 'D3', parentId: 'D1-plant-overview', title: { vi: 'Điều khiển SCR & FGD', en: 'SCR/FGD Control' } },
